...
function HomePage() {
  ...
  if (loading) return /* @__PURE__ */ import_react.default.createElement("div", { className: "p-4" }, "Loading restaurants...");
  if (error) return /* @__PURE__ */ import_react.default.createElement("div", { className: "p-4 text-red-500" }, "Error: ", error);
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "p-6 max-w-4xl mx-auto" }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "text-2xl font-bold mb-6" }, "Restaurants"), "debugger", restaurants.length > 0 ? /* @__PURE__ */ import_react.default.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, restaurants.map((restaurant) => /* @__PURE__ */ import_react.default.createElement("div", { key: restaurant.id, className: "border rounded-lg p-4 shadow hover:shadow-md transition-shadow" }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "text-xl font-semibold" }, restaurant.name), /* @__PURE__ */ import_react.default.createElement("p", { className: "text-gray-600" }, "Cuisine: ", restaurant.cuisine)))) : /* @__PURE__ */ import_react.default.createElement("p", { className: "text-gray-600" }, "No restaurants found."));
}
...
var mount = () => {
  ...
  if (el) {
    (0, import_client.createRoot)(el).render(/* @__PURE__ */ import_react2.default.createElement(HomePage_default, null));
  }
};
