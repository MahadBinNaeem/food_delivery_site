...
function HomePage() {
    ...
    const fetchRestaurants = async () => {
      try {
        const response = await fetch(`/api/v1/restaurants`, {
          ...
          credentials: "include"
          // Important for cookies/sessions if using them
        });
        if (!response.ok) {
  ...
  if (loading) return /* @__PURE__ */ import_react.default.createElement("div", null, "Loading restaurants...");
  if (error) return /* @__PURE__ */ import_react.default.createElement("div", null, "Error: ", error);
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "restaurants-container" }, /* @__PURE__ */ import_react.default.createElement("h1", null, "Restaurants"), restaurants.length > 0 ? /* @__PURE__ */ import_react.default.createElement("ul", { className: "restaurants-list" }, restaurants.map((restaurant) => /* @__PURE__ */ import_react.default.createElement("li", { key: restaurant.id, className: "restaurant-item" }, /* @__PURE__ */ import_react.default.createElement("h1", null, restaurant.name), /* @__PURE__ */ import_react.default.createElement("p", null, "Cuisine: ", restaurant.cuisine)))) : /* @__PURE__ */ import_react.default.createElement("p", null, "No restaurants found."));
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (container) {
    ...
    root.render(/* @__PURE__ */ import_react2.default.createElement(HomePage_default, null));
  }
});
